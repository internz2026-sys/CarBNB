          ...
          <Link
            ...
            className={cn(
              compact
                ...
                : "group relative flex items-center gap-3 rounded-xl px-4 py-3.5 text-[1.05rem] font-medium transition-all",
              isActive
                ? compact
...
export function Sidebar() {
  return (
    <aside className="fixed inset-y-0 left-0 z-50 hidden w-[18rem] flex-col bg-[rgb(210_217_244_/_0.78)] px-7 py-8 backdrop-blur-[12px] xl:flex">
      <div className="mb-12">
        <span className="font-headline text-[2rem] font-semibold tracking-tight text-primary">
          Admin Panel
        </span>
        <p className="mt-1 text-[1.05rem] text-on-surface-variant">The Curated Engine</p>
      </div>
      ...
      <div className="mt-8 rounded-[1.25rem] bg-surface-container-lowest/80 p-4 shadow-[0_8px_28px_rgb(19_27_46_/_0.06)]">
        <div className="flex items-center gap-4">
          <div className="grid size-14 place-items-center rounded-[1rem] bg-surface-container-highest text-base font-semibold text-primary">
            AR
          </div>
          <div>
            <p className="text-[1.05rem] font-semibold text-on-surface">Alex Rivera</p>
