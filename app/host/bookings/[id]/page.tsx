          ...
          <Card className="overflow-hidden border-border/50 shadow-sm">
            ...
            <CardContent className="pt-4 text-sm space-y-2">
              ...
              <Link
                ...
                href={`/host/cars/${booking.carListing.id}/edit`}
              >
                Manage this listing
              </Link>
            </CardContent>
          ...
          <Card className="border-border/50 shadow-sm">
            ...
            <CardContent className="pt-4 space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="font-medium">{peso.format(booking.totalAmount)}</span>
              </div>
              ...
              <div className="flex justify-between border-t border-border pt-2">
                <span className="font-semibold">Owner payout</span>
              ...
              {booking.paymentStatus === PaymentStatus.PAID ? (
                <div className="mt-3 rounded-md bg-emerald-50 p-3 text-xs text-emerald-900">
                  <p className="flex items-center gap-2 font-semibold">
                    ...
                    Customer paid {booking.paymentMethod ? `via ${booking.paymentMethod}` : ""}
                  </p>
                  {booking.paymentReceivedAt ? (
                    <p className="mt-1">
                      Received {format(booking.paymentReceivedAt, "MMM d, yyyy · h:mm a")}
                    </p>
                  ) : null}
                </div>
              ) : null}
