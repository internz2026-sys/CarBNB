...
import {
  uploadHostOrCrDocumentAction,
  type HostListingActionState,
} from "@/app/actions/host-listings";

export function HostListingOrCrForm({
  listingId,
  orCrPath,
  signedUrl,
}: {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Required before your listing can be approved. Uploaded to a private bucket — only
          admins can view it via short-lived signed URLs.
        </CardDescription>
      </CardHeader>
