...
import {
  addHostAvailabilityExceptionAction,
  deleteHostAvailabilityExceptionAction,
...
export function HostAvailabilityExceptionsForm({
  listingId,
  exceptions,
}: {
  listingId: string;
  ...
  const [addState, addAction, addPending] = useActionState<HostListingActionState, FormData>(
    addHostAvailabilityExceptionAction,
    null,
  );
  const [deleteState, deleteAction] = useActionState<HostListingActionState, FormData>(
    deleteHostAvailabilityExceptionAction,
    null,
  );
        ...
        <form action={addAction} className="grid gap-3 md:grid-cols-[1fr_1fr_2fr_auto] md:items-end">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              maxLength={200}
              name="reason"
              placeholder="e.g. Maintenance, traveling, holiday"
            />
          </div>
