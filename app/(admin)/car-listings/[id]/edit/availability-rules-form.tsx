...
export function AvailabilityRulesForm({
  listingId,
  rules,
}: {
  listingId: string;
    ...
    <form action={formAction}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Toggle each day this car is rentable and set its daily window. Changes here update
            the availability summary shown on listing cards.
          </CardDescription>
        </CardHeader>
